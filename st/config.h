 ...
 */
static char *font =
    "FiraCode Nerd Font:pixelsize=6:antialias=true:autohint=true";
static char *font2[] = {"JoyPixels:pixelsize=5:antialias=true:autohint=true"};
...
static Shortcut shortcuts[] = {
    ...
    {TERMMOD, XK_U, kscrollup, {.i = 3}},
    {TERMMOD, XK_E, kscrolldown, {.i = -3}},
